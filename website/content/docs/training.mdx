...
This is a small API example with synthetic data, not a performance benchmark. For a real model end to end, see [Train nanoGPT on a remote GPU](/docs/nanogpt), which needs two changed lines. Downloading a loss every step adds a host wait. Decide how frequently you need metrics.
